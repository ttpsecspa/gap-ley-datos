...
const mockRequests: (SubjectRequest & { assigned_to_name?: string })[] = [
  {
    ...
    request_type: "ACCESO",
    requester_name: "Maria Gonzalez Rojas",
  ...
  },
  {
    ...
    requester_name: "Roberto Fernandez Castillo",
  ...
  },
  {
    ...
    logs: [
      ...
      { id: "log-17", request_id: "req-005", action: "Extraccion de datos iniciada", performed_by_id: "user-3", notes: "Generando exportacion desde BD principal", performed_at: "2026-03-12T11:00:00Z" },
    ],
  },
  {
    id: "req-006",
    ...
    description: "Solicito el bloqueo temporal del tratamiento de mis datos mientras se resuelve un reclamo ante la Agencia de Proteccion de Datos.",
    status: "EN_PROCESO",
    ...
    logs: [
      ...
      { id: "log-19", request_id: "req-006", action: "Asignada a Laura Diaz", performed_by_id: "user-admin", notes: "Caso prioritario - reclamo ante Agencia", performed_at: "2026-03-11T09:00:00Z" },
